...
const mockSearchCriteriaData = {
  flightSearchCriteria: {
    ...
    originAirport: "DEL",
    isRoundTrip: true,
    passengers: [{ id: 1, type: "adult" }, { id: 2, type: "adult" }],
  },
...
const mockFlights = [
  {
    ...
    rankingScore: 8.5,
    pros: ["Direct flight", "Good timing", "Reliable airline", "Free cancellation"],
  ...
  },
  {
    ...
    rankingScore: 9.2,
    pros: ["Premium service", "Direct flight", "Evening departure", "Complimentary meals"],
  ...
  },
  {
    ...
    rankingScore: 8.8,
    pros: ["Late night departure", "Premium aircraft", "Shortest duration", "Business class available"],
  ...
  },
  {
    ...
    rankingScore: 9.5,
    pros: ["Fastest flight", "Premium service", "Midday departure", "Free meals and drinks"],
  ...
  },
  {
    ...
    rankingScore: 8.2,
    pros: ["Afternoon departure", "Reliable airline", "Good timing", "Refundable"],
        ...
        <div className="space-y-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-center mb-8">
              These widgets are used for user input and interaction in chat conversations
            </p>
          </div>
          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Interactive form for flight search parameters. Used when the agent needs user input for flight search criteria.
              </p>
            </div>
            <div className="w-full">
          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Interactive flight selection interface. Used when the agent presents flight options for user selection.
              </p>
            </div>
            <div className="flex justify-center">
          ...
          <div className="mt-16 mb-8">
            ...
            <p className="text-gray-600 text-center mb-8">
              These widgets display information sent from the server (marked as "simple widget needs to send from server")
            </p>
          </div>
          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Display-only widget showing weather information with hourly forecast.
              </p>
            </div>
            <div className="flex justify-center">
              <WeatherWidget />
          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Comprehensive flight booking review page with collapsible sections, form validation, and responsive design.
              </p>
            </div>
            <div className="w-full">
              <ReviewWidget />
        ...
        <div className="mt-16 text-center">
          <div className="bg-blue-50 rounded-lg p-6 max-w-4xl mx-auto">
            ...
            <p className="text-blue-800 text-sm mb-4">
              These widgets are rendered in chat conversations through the LangGraph interrupt system.
              The server sends widget data via interrupts, and the client renders the appropriate widget based on the type.
            </p>
            <div className="text-left text-sm text-blue-700">
              <p className="mb-2"><strong>Interactive widgets</strong> collect user input and send responses back to continue the conversation.</p>
              <p><strong>Display widgets</strong> show information sent from the server without requiring user interaction.</p>
            </div>
          </div>
        </div>
      </div>
